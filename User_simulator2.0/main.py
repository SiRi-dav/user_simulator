...
def build_case_analysis_artifacts(
    ...
    related_cases = RelatedCaseRetriever(
        ...
        recall_top_n=int(retrieval_config.get("candidate_top_n", 30)),
        per_route_top_n=int(retrieval_config.get("per_route_top_n", 8)),
        rerank_top_n=int(retrieval_config.get("rerank_top_n", 12)),
